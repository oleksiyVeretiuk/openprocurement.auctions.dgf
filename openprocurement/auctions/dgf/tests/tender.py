...
class AuctionResourceTest(BaseWebTest):
    ...
    test_daylight_savings_timezone = snitch(daylight_savings_timezone)
...
class FinancialAuctionResourceTest(AuctionResourceTest):
    ...
    test_create_auction_generated = snitch(create_auction_generated_financial)
